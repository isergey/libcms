...
@login_required
@permission_required_or_403('professionals_news.change_news')
@transaction.atomic
def edit_news(request, id):
    ...
    return render(request, 'professionals_news/administration/edit_news.html', {
        'news_form': news_form,
        'news_content_forms': news_content_forms,
        })
...
@login_required
@permission_required_or_403('professionals_news.delete_news')
@transaction.atomic
